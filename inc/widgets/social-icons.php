<?php
    ...
    class kotha_tswb_social_Widget extends WP_Widget
    {
        ...
        public function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('github')); ?>"><?php _e('Enter github URL:', 'kotha'); ?></label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('github')); ?>" name="<?php echo esc_attr($this->get_field_name('github')); ?>" type="text" value="<?php echo esc_url($github); ?>">
            </p>
            ...
            <div class="social-link">
                <ul class="list-inline">
                    ...
                    <?php $github_link = $instance['github'];
                        if ($github_link) { ?>
                            <li><a href="<?php echo esc_url($github_link) ?>" class="github"><i class="fa fa-github"></i></a></li>
                    <?php } ?>
    ...
    if (!function_exists('kotha_social_icon_register')) {
        ...
        {
            register_widget('kotha_tswb_social_Widget');
        }
