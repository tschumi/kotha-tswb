...
<!-- Video Post -->
    <?php elseif(has_post_format('video')) : ?>
        ...
        <div class="thumbnails">
			...
			<?php if ( function_exists( 'lyte_parse' ) ) { $st_video = lyte_parse( $st_video ); } ?>
...
<!-- Audio Post -->
    ...
    <?php else : ?>
        ...
        <div class="thumbnails">
            ...
            <?php if( $caption ) : ?>
            <div class="thumbnails-caption"><span><?php echo get_post(get_post_thumbnail_id( $post->ID ))->post_excerpt;  ?></span></div>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    ...
    <div class="padding-content text-center">
        ...
        <div class="entry-content">
            <?php the_content(__('<span class="read-more-button">Keep Reading</span>', 'kotha')); ?>
